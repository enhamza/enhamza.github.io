...
* Second order splitting dynamics for stochastic monotone inclusions with closed loop distribution, with W.Si and [J.Fadili](https://fadili.users.greyc.fr). [arXiv Link](https://arxiv.org/abs/2606.06280)-[HAL Link](https://hal.science/view/index/docid/5645086). 2026, Submitted.
